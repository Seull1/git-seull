...
//		d = y; //묵시적 형변환
		...
		int c = Ia.intValue(); //jdk4.x 이전까지 사용하던 메소드
		int e =Ib; //5.x 버전 이후부터는 자동으로 됨
		...
		System.out.println(Integer.toOctalString(10));  //8진수 10
		System.out.println(Integer.toHexString(10));  //  16진수 10
		System.out.println(Integer.toBinaryString(10)); //2진수 10
